...
//OnAuthenticationFailed = context =>
//{
//    var logger = Log.ForContext<JwtBearerEvents>(); // Modified
//    logger.Error(context.Exception, "Authentication failed"); // Modified
//    return Task.CompletedTask;
//},
//OnTokenValidated = context =>
//{
//    var logger = Log.ForContext<JwtBearerEvents>(); // Modified
//    logger.Information("Token validated successfully"); // Modified
//    return Task.CompletedTask;
//},
//OnChallenge = context =>
//{
//    var logger = Log.ForContext<JwtBearerEvents>(); // Modified
//    logger.Warning("OnChallenge: {Error}", context.Error); // Modified
//    return Task.CompletedTask;
//},
//OnMessageReceived = context =>
//{
//    var logger = Log.ForContext<JwtBearerEvents>(); // Modified
//    logger.Information("Token received: {Token}", context.Token); // Modified
//    return Task.CompletedTask;
//}