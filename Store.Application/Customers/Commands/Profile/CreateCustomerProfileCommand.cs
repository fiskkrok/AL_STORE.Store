...
public class CreateCustomerProfileCommandHandler : IRequestHandler<CreateCustomerProfileCommand, Result<CustomerProfileDto>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (existingProfile != null)
            return Result<CustomerProfileDto>.Failure(new Error("Profile.Duplicate", "A profile with this email already exists"));
