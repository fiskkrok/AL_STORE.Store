...
public class KlarnaSessionResponse
{
    ...
    {
        return JsonSerializer.Deserialize<KlarnaSessionResponse>(json,
...
{
    [JsonPropertyName("asset_urls")] public AssetUrls AssetUrls { get; set; } = new();
...
{
    [JsonPropertyName("descriptive")] public string Descriptive { get; set; } = string.Empty;

    [JsonPropertyName("standard")] public string Standard { get; set; } = string.Empty;
}